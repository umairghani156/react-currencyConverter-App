...
//  useEffect(() => {
  async  function rupeesConverter() {
      ...
      myHeaders.append("apikey", "s2ssWgsL4R5uDEk130JA2UKclHBcdVon");
     ...
     await fetch(
        "https://api.apilayer.com/exchangerates_data/convert?to=PKR&from=USD&amount=10",
        requestOptions
      )
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex",flexDirection:"column",alignItems:"center", gap: "10px", padding:"20px"}}>
        ...
        <input className="w-15 hello" type="text"/>
        ...
        <select name="" id="rupees1" className="hello" style={{width:"100%"}}>
    ...
    <option value="ZMK">Zambian Kwacha</option>
        ...
        <select name="" id="rupees2" className="hello" style={{width:"100%"}}>
        <option>select currency</option>
    <option value="AFN">Afghan Afghani</option>
    <option value="ALL">Albanian Lek</option>
    <option value="DZD">Algerian Dinar</option>
    ...
    <option value="ZMK">Zambian Kwacha</option>
        ...
        <div style={{width:"100%", display:"flex", justifyContent:"space-between"}}>
          <button style={{border:"2px solid #afafaf", padding:"5px 10px",fontWeight:"600", borderRadius:"7px"}}>Clear</button>
          <button style={{border:"2px solid #afafaf", padding:"5px 10px",fontWeight:"600", borderRadius:"7px"}}>Calculate</button>
        </div>
        </div>
        <Answer/>
      </div>
